jQuery(document).ready(function ($) {
  "use strict";
  function zentimo_google_maps() {
    if ($(".zentimo-google-maps").length <= 0) {
      return;
    }
    $(".zentimo-google-maps").each(function () {
      var $this = $(this),
        $id = $this.attr("id"),
  ...
  function zentimo_init_menu_toggle() {
    var contain = ".zentimo-nav-toggle";
  ...
  // ----------zentimo_custom_scrollbar-------------------
  function zentimo_custom_scrollbar() {
    $(".zentimo-mini-cart .minicart-items").mCustomScrollbar();
    $(".zentimo-mini-cart .minicart-items").change(function () {
      $(".zentimo-mini-cart .minicart-items").mCustomScrollbar();
    });
  }

  function zentimo_custom_scrollbar_header_nav() {
    $(
  ...
  //------------------ Video Lightbox------------
  function zentimo_video() {
    $(".quick-install").simpleLightboxVideo();
  }

  // --------------------remove_class_equal--------------------------
  function zentimo_remove_class_review() {
  ...
  // -----------zentimo_details_thumd--------------------
  function zentimo_details_thumd_zoom() {
    /* ------------------------------------------------
         Arctic modal
         ------------------------------------------------ */
    if ($.arcticmodal) {
  ...
  /* TOGGLE */
  function zentimo_dropdown() {
    $(document).on("click", ".header-control .close", function () {
      $(this).closest(".zentimo-dropdown").removeClass("open");
    });
    $(document).on("click", function (event) {
      var _target = $(event.target).closest(".zentimo-dropdown");
      var _allparent = $(".zentimo-dropdown");

      if (_target.length > 0) {
        _allparent.not(_target).removeClass("open");
        if (
          $(event.target).is('[data-zentimo="zentimo-dropdown"]') ||
          $(event.target).closest('[data-zentimo="zentimo-dropdown"]').length >
            0
        ) {
        ...
        $(".zentimo-dropdown").removeClass("open");
      }
    });
  }

  function zentimo_mobile_block() {
    $(document).on(
      "click",
  ...
  // =====================slick============================
  function zentimo_init_carousel() {
    $(".owl-slick")
  ...
  /* ---------------------------------------------
     TAB EFFECT
     --------------------------------------------- */
  function zentimo_tab_fade_effect() {
    // effect click
    $(document).on("click", ".zentimo-tabs .tab-link a", function () {
  ...
  $(window).on("scroll", function () {
    if ($(window).scrollTop() > 1000) {
      ...
      $(".contactchat").css("bottom", "100px");
    } else {
      $(".backtotop").removeClass("show");
      $(".contactchat").css("bottom", "50px");
    }
  });
  ...
  function zentimo_countdown() {
    if ($(".zentimo-countdown").length > 0) {
      ...
      $(".zentimo-countdown").each(function () {
  ...
  $(window).resize(function () {
    ...
    zentimo_masonry();
    kt_resizeMegamenu();
    zentimo_remove_class_review();
    zentimo_details_thumd_zoom();
    zentimo_custom_scrollbar();
  });
  $(window).load(function () {
    newletter_popup();
    quickview_popup();
    zentimo_mobile_block();
    zentimo_remove_class_review();
    zentimo_custom_scrollbar();
  });
  zentimo_masonry();
  zentimo_dropdown();
  zentimo_init_carousel();
  zentimo_remove_class_review();
  zentimo_tab_fade_effect();
  zentimo_details_thumd_zoom();
  zentimo_video();
  kt_resizeMegamenu();
  zentimo_custom_scrollbar();
  zentimo_countdown();
  zentimo_init_menu_toggle();
  zentimo_custom_scrollbar_header_nav();
});
